...
export default function HomeScreen({ route, navigation }: any) {
  ...
  // Recording context
  const { setForceNew, setHasStartedRecording } = useRecording()
  ...
  useEffect(() => {
    ...
    if (currentState.isRecording && currentState.userId === userId) {
      setIsRecording(true);
      ...
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          ...
          <View style={styles.brainIconContainer}>
            <Image source={require('../assets/brain.png')} style={styles.brainIcon} />  
          </View>
        </View>
        <View style={styles.progressContainer}>
          <View style={styles.progressBar}>
            <LinearGradient
              colors={['#ffb366', '#ff6b35']}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 0 }}
      ...
      <View style={styles.bottomBar}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            navigation.navigate('CaptureScreen', { userId })
          }}
        >
